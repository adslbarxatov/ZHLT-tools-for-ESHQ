...
//=============================================================================
// misc functions
extern void GetParamsFromEnt_BSP (entity_t *mapent);		// ESHQ: разделение имён
...
extern bool		g_chart_bsp;			// ESHQ: разделение имён
extern bool		g_estimate_bsp;			// ESHQ: разделение имён
...
#ifdef ZHLT_NULLTEX // AJM
extern bool		g_bUseNullTex_bsp;	// ESHQ: разделение имён
#endif
