...
// Common explanations
#define contact contactmerl //"contact zoner@gearboxsoftware.com immidiately"
...
static const MessageTable_t assumes[assume_last] = {
	...
	//KGP added
	{"Exceeded MAX_MAP_LIGHTING","You have run out of light data memory" ,"Use the -lightdata <#> command line option to increase your maximum light memory. The default is 6144 (KB)."},
