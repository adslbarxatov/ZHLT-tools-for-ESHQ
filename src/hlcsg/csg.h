...
// ESHQ: отключено, т.к. необратимо повреждает структуру BSP
#if 0
...
#ifdef HLCSG_CLIPECONOMY // AJM
	unsigned int	noclip;
	// !!!FIXME: this should be a flag bitfield so we can use it for other stuff (ie. is this a detail brush...)
#endif
...
extern bool			g_chart_csg;		// ESHQ: разделение имён
extern bool			g_onlyents;
extern bool			g_noclip_csg;
extern bool			g_wadtextures;
extern bool			g_skyclip;
extern bool			g_estimate_csg;		// ESHQ: разделение имён
extern const char	*g_hullfile;

#ifdef ZHLT_NULLTEX // AJM:
extern bool			g_bUseNullTex_csg;	// ESHQ: разделение имён
#endif
...
extern void		GetParamsFromEnt_CSG (entity_t *mapent);	// ESHQ: разделение имён
